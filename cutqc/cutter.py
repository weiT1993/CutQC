...
class MIP_Model(object):
    ...
    max_subcircuit_width, max_subcircuit_cuts, subcircuit_size_imbalance, num_qubits, max_cuts):
    ...
    def _add_variables(self):
        ...
        for subcircuit in range(self.num_subcircuit):
            ...
            self.subcircuit_counter[subcircuit]['original_input'] = self.model.addVar(lb=0.1, ub=self.max_subcircuit_width, vtype=gp.GRB.INTEGER, name='original_input_%d'%subcircuit)
            ...
            self.subcircuit_counter[subcircuit]['size'] = self.model.addVar(lb=self.n_vertices/self.num_subcircuit/self.subcircuit_size_imbalance,
            ub=self.n_vertices/self.num_subcircuit*self.subcircuit_size_imbalance, vtype=gp.GRB.INTEGER, name='size_%d'%subcircuit)
...
max_cuts, num_subcircuits, max_subcircuit_cuts, subcircuit_size_imbalance,
verbose):
