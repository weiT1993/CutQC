...
if __name__ == '__main__':
    ...
    cutqc = CutQC(circuit_name='largest_QV_%d_shots'%(constant_shots),circuit=circuit,verbose=False)
    ...
    # source_folder = cutqc.cut(num_shots_fn=constant_shots_fn,subcircuit_vertices=[range(26),[26,27,28],[29,30,31]])
