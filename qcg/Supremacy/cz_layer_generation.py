        ...
        for row in range(0, nrow, 2):
            for col in range(0, ncol, 4):
                if col + starting_idx + 1 < ncol:
                    cz_list += [
                        ([row, col + starting_idx], [row, col + starting_idx + 1])
                    ]
                if col + starting_idx + 2 + 1 < ncol and row + 1 < nrow:
                    cz_list += [
                        (
                            [row + 1, col + starting_idx + 2],
                            [row + 1, col + starting_idx + 3],
                        )
                    ]
        ...
        for col in range(0, ncol, 2):
            for row in range(0, nrow, 4):
                if row + starting_idx - 4 + 1 < nrow:
                    cz_list += [
                        ([row + starting_idx - 4, col], [row + starting_idx - 3, col])
                    ]
                if row + starting_idx - 4 + 2 + 1 < nrow and col + 1 < ncol:
                    cz_list += [
                        (
                            [row + starting_idx - 2, col + 1],
                            [row + starting_idx - 1, col + 1],
                        )
                    ]
        ...
        for col in range(0, ncol, 2):
            for row in range(0, nrow, 4):
                if row + starting_idx - 4 - 2 + 1 < nrow and col + 1 < ncol:
                    cz_list += [
                        (
                            [row + starting_idx - 6, col + 1],
                            [row + starting_idx - 5, col + 1],
                        )
                    ]
                if row + starting_idx - 4 + 1 < nrow:
                    cz_list += [
